...
if TYPE_CHECKING:
    ...
    from agents.agents import DEFAULT_AGENT, AgentGraph, get_agent, get_all_agent_info  # noqa: F401


def __getattr__(name: str):
    if name in {"get_agent", "get_all_agent_info", "DEFAULT_AGENT", "AgentGraph"}:
