...
def workflow(chosen_model):
    ...
    research_supervisor = create_agent(
        model=chosen_model,
        tools=[web_search, transfer_to_math_expert],
        system_prompt=(
            "You are a world class researcher with access to web search. "
            "When you need to do math, use transfer_to_math_expert. "
    ...
    def transfer_to_research_expert(request: str) -> str:
        ...
        The research expert has access to web search and can transfer to a math expert.
    ...
    main_supervisor = create_agent(
        model=chosen_model,
        tools=[transfer_to_research_expert],
        system_prompt=(
            ...
            "use transfer_to_research_expert."
        ),
    )
